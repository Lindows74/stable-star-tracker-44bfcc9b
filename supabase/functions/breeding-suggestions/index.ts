    ...
    const raceMatches = liveRaces.map(race => {
      ...
      const matchingHorses = horseLookup
        ...
        .map(({ horse }) => ({
          ...
          jump: horse.jump,
          diet_speed: horse.diet_speed,
          diet_sprint_energy: horse.diet_sprint_energy,
          diet_acceleration: horse.diet_acceleration,
          diet_agility: horse.diet_agility,
          diet_jump: horse.diet_jump,
